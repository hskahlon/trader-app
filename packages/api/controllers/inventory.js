...
const addInventory = async (req, res) => {
    ...
    if(oldInventory.length != 0) {
        ...
        Inventory.findByIdAndUpdate({ _id: oldInventory[0]._id }, { quantity: newQuantity }, { useFindAndModify: false }, function() {
  ...
  const sellInventory = async (req, res) => {
    ...
    if(oldInventory.length != 0) {
        ...
        if(newQuantity < 1) {
            Inventory.findByIdAndDelete(oldInventory[0]._id, { useFindAndModify: false }, function() {
